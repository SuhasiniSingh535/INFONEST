            ...
            <div className="schedule-container">
                ...
                <div className="schedule-content">
                    <div className="search-form card">
                        ...
                        <div className="search-sub-modes" style={{ marginBottom: '15px', display: 'flex', gap: '10px' }}>
                            <button className="btn btn-secondary btn-sm" onClick={handleCabinSearch}><i className="fa-solid fa-house" style={{ marginRight: '6px' }} /> Sitting Cabin</button>
                            <button className="btn btn-secondary btn-sm" onClick={() => setShowAdvanced(true)}><i className="fa-solid fa-calendar-days" style={{ marginRight: '6px' }} /> Custom Search</button>
                        </div>
                        ...
                        <button
                            ...
                            disabled={loading}
                        >
                            {loading ? 'Searching...' : <><i className="fa-solid fa-crosshairs" style={{ marginRight: '6px' }} /> Locate Teacher Now</>}
                        </button>
                        ...
                        {showSchedule && scheduleData && (
                            <div className="schedule-result" style={{ marginTop: '20px' }}>
                                <div className="location-card teacher-location">
                                    <div className="location-icon"><i className="fa-solid fa-location-dot" style={{ color: '#2563eb' }} /></div>
                ...
                {showAdvanced && (
                    ...
                    >
                        ...
                        >
                            ...
                            <h3><i className="fa-solid fa-calendar-days" style={{ marginRight: '8px', color: '#2563eb' }} /> Custom Schedule Search</h3>
                            <div className="form-group">
                ...
                {isManagementMode && selectedTeacher && (
                    <div className="upload-section card" style={{ marginTop: '20px', border: '1px solid #007bff', padding: '20px' }}>
                        <h3>{isUpdateMode ? <><i className="fa-solid fa-arrows-rotate" style={{ marginRight: '6px' }} /> Replace</> : <><i className="fa-solid fa-plus" style={{ marginRight: '6px' }} /> Add</>} Schedule for {selectedTeacher.firstName}</h3>
